...
author: "Francisco Uriel Ledezma Chávez"
format: html
>>>>>>> e5d5e6252a40d6b5ffeee4d40bf5e9e9d13a1f4a
editor: visual
---
...
<<<<<<< HEAD
1.- Se selecciona `get = "economic.data"` para obtener datos económicos desde el FRED. 2.- Se convierte la columna `date` a un formato de fecha mensual utilizando `yearmonth()`, porque nuestra serie es mensual.
=======
...
=======
El mejor modelo parece ser el stlf. Vamos a utilizar este para hacer el pronóstico final.
>>>>>>> e5d5e6252a40d6b5ffeee4d40bf5e9e9d13a1f4a
